...
@Feature("网站信息--联系我们")
public class Contact extends BaseDriver {

    @BeforeMethod
    public void openURL() {
        driver.get("http://www.10086.cn/web_notice/contact/");
    ...
    @Story("网站信息--联系我们")
    @Test
    public void contactListTest() throws InterruptedException {
        windowsHandle = driver.getWindowHandle(); //获取当前handle
        //获取所有text的List集合
        List<String> listString = WebNoticePagePro.contactList(driver);
...
//            driver.findElement(By.xpath("//a[@href='"+listString.get(i)+"']")).click();
